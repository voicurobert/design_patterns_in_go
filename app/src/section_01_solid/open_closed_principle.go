...
// the methods above violates the open-closed principle

// implementing Specification interface
...
func OpenClosedPrinciple() {
	fmt.Printf("Open-Closed Principle...")
	...
	fmt.Printf("Large and Green products (new):\n")
